...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
      ...
      <div class="relative flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 bg-white dark:border-sidebar-border dark:bg-black">
        <div class="overflow-x-auto">
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead class="w-[20%]">Name</TableHead>
                <TableHead class="w-[45%]">Description</TableHead>
                <TableHead class="w-[20%]">Device ID</TableHead>
            ...
            <TableBody>
              ...
              <TableRow v-for="location in locations" :key="location.id">
                ...
                <TableCell>
                  <div class="font-mono truncate">{{ location.deviceId }}</div>
                </TableCell>
                <TableCell class="text-right whitespace-nowrap">
                  <div class="flex justify-end gap-2">
                    ...
                    <Link :href="route('locations.destroy', location.id)" method="delete" as="button" preserve-scroll>
                      <Button variant="outline" size="icon">
