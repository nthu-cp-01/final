        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <div
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Controller Shadow Name</h3>
                        <p class="mt-1 text-lg font-mono">{{ location.controllerShadowName }}</p>
                    </div>

                    <div>
                        <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Sensor Shadow Name</h3>
                        <p class="mt-1 text-lg font-mono">{{ location.sensorShadowName }}</p>
                    </div>
