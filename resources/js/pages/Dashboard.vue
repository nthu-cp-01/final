        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            <div class="grid auto-rows-min gap-4 md:grid-cols-3">
                ...
                <Link :href="route('locations.index')" class="block">
                    <div class="relative aspect-video overflow-hidden rounded-xl border border-sidebar-border/70 bg-white dark:border-sidebar-border dark:bg-black hover:border-green-300 dark:hover:border-green-600 transition-colors cursor-pointer">
                        <div class="p-6 h-full flex flex-col justify-between">
                            <div class="flex items-center justify-between">
                                <div>
                ...
                <Link :href="route('items.index')" class="block">
                    <div class="relative aspect-video overflow-hidden rounded-xl border border-sidebar-border/70 bg-white dark:border-sidebar-border dark:bg-black hover:border-purple-300 dark:hover:border-purple-600 transition-colors cursor-pointer">
                        <div class="p-6 h-full flex flex-col justify-between">
                            <div class="flex items-center justify-between">
                                <div>
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-3">
                            <div class="flex h-10 w-10 items-center justify-center rounded-full bg-yellow-50 dark:bg-yellow-900/20">
                            ...
                            <div class="flex flex-col items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-muted-foreground">
                                        ...
                                        <Link :href="route('loaning-forms.index')" class="text-primary hover:underline ml-1">
                                            View all requests
                                        </Link>
                                    </p>
                                </div>
